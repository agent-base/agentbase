...
class ResetPasswordApi(Resource):
    ...
    def get(self):
        ...
        # todo: Send email
        # MAILCHIMP_API_KEY = agentbase_config.MAILCHIMP_TRANSACTIONAL_API_KEY
        ...
        #     'html': """
        #         <p>Dear User,</p>
        #         <p>The AgentBase team has generated a new password for you, details as follows:</p>
        #         <p><strong>{new_password}</strong></p>
        #         <p>Please change your password to log in as soon as possible.</p>
        #         <p>Regards,</p>
        #         <p>The AgentBase Team</p>
        #     """
        # }
        ...
        #     ' settings': {
        #         'sandbox_mode': agentbase_config.MAILCHIMP_SANDBOX_MODE,
        #     },
        # })
