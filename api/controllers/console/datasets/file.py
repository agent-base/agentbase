...
class FileApi(Resource):
    ...
    def get(self):
        file_size_limit = agentbase_config.UPLOAD_FILE_SIZE_LIMIT
        batch_count_limit = agentbase_config.UPLOAD_FILE_BATCH_LIMIT
        image_file_size_limit = agentbase_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT
        return {
...
class FileSupportTypeApi(Resource):
    ...
    @account_initialization_required
    def get(self):
        etl_type = agentbase_config.ETL_TYPE
