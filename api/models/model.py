...
class AgentBaseSetup(db.Model):
    __tablename__ = "agentbase_setups"
    __table_args__ = (db.PrimaryKeyConstraint("version", name="agentbase_setup_pkey"),)
...
class App(db.Model):
    ...
    def api_base_url(self):
        return (agentbase_config.SERVICE_API_URL or request.host_url.rstrip("/")) + "/v1"
...
class Site(db.Model):
    ...
    def app_base_url(self):
        return agentbase_config.APP_WEB_URL or request.url_root.rstrip("/")
