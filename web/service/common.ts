...
export const fetchLanggeniusVersion: Fetcher<Agent-BaseVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<Agent-BaseVersionResponse>(url, { params })
}
