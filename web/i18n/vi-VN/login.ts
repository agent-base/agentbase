const translation = {
  ...
  welcome: 'Chào mừng bạn đến với AgentBase, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của AgentBase, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại AgentBase',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá AgentBase',
