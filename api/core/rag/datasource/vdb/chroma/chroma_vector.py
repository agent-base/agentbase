...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=agentbase_config.CHROMA_HOST,
                port=agentbase_config.CHROMA_PORT,
                tenant=agentbase_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=agentbase_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=agentbase_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=agentbase_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
