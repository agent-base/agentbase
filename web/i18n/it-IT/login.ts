const translation = {
  ...
  welcome: 'Benvenuto su AgentBase, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AgentBase Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AgentBase',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AgentBase',
