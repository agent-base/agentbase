...
from agentbase_client.client import ChatClient, CompletionClient, AgentBaseClient, KnowledgeBaseClient

API_KEY = os.environ.get("API_KEY")
APP_ID = os.environ.get("APP_ID")
API_BASE_URL = os.environ.get("API_BASE_URL", "https://api.agentbase.ai/v1")
...
class TestAgentBaseClient(unittest.TestCase):
    def setUp(self):
        self.agentbase_client = AgentBaseClient(API_KEY)

    def test_message_feedback(self):
        response = self.agentbase_client.message_feedback("your_message_id", 'like', "test_user")
        self.assertIn("success", response.text)

    def test_get_application_parameters(self):
        response = self.agentbase_client.get_application_parameters("test_user")
    ...
    def test_file_upload(self):
        ...
        with open(file_path, "rb") as file:
            ...
            response = self.agentbase_client.file_upload("test_user", files)
