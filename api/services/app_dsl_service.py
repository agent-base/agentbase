...
dsl_to_agentbase_version_mapping: dict[str, str] = {
    "0.1.2": "0.8.0",
    "0.1.1": "0.6.0",  # dsl version -> from agentbase version
}
    ...
    def _check_or_fix_dsl(cls, import_data: dict) -> dict:
        ...
        if import_data.get("version") != current_dsl_version:
            ...
            logger.warning(
                ...
                f"AgentBase version {dsl_to_agentbase_version_mapping.get(current_dsl_version)}."
            )
