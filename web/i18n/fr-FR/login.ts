const translation = {
  ...
  welcome: 'Bienvenue sur AgentBase, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AgentBase Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AgentBase',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AgentBase',
