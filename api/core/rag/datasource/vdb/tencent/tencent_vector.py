    ...
    def _create_collection(self, dimension: int) -> None:
        ...
        with redis_client.lock(lock_name, timeout=20):
            ...
            self._db.create_collection(
                ...
                description="Collection for AgentBase",
                index=index,
            )
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=agentbase_config.TENCENT_VECTOR_DB_URL,
                api_key=agentbase_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=agentbase_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=agentbase_config.TENCENT_VECTOR_DB_USERNAME,
                database=agentbase_config.TENCENT_VECTOR_DB_DATABASE,
                shard=agentbase_config.TENCENT_VECTOR_DB_SHARD,
                replicas=agentbase_config.TENCENT_VECTOR_DB_REPLICAS,
            ),
        )
