const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AgentBase',
    langGeniusAccountTip: 'Il tuo account AgentBase e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AgentBase per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AgentBase ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AgentBase.',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} è ora disponibile.',
    latestAvailable: 'AgentBase {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
