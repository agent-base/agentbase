const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte AgentBase',
    langGeniusAccountTip: 'Votre compte AgentBase et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à AgentBase pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par AgentBase vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de AgentBase.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.agentbase.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} est maintenant disponible.',
    latestAvailable: 'AgentBase {{version}} est la dernière version disponible.',
  },
  appMenus: {
