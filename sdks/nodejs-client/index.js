...
export const BASE_URL = "https://api.agentbase.ai/v1";
...
export class CompletionClient extends AgentBaseClient {
...
export class ChatClient extends AgentBaseClient {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends AgentBaseClient {
