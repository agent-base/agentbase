...
class AgentBaseClient:
    def __init__(self, api_key, base_url: str = "https://api.agentbase.ai/v1"):
...
class WorkflowClient(AgentBaseClient):
...
class KnowledgeBaseClient(AgentBaseClient):
    def __init__(self, api_key, base_url: str = "https://api.agentbase.ai/v1", dataset_id: str = None):
        """
        Construct a KnowledgeBaseClient object.

        Args:
            api_key (str): API key of AgentBase.
            base_url (str, optional): Base URL of AgentBase API. Defaults to 'https://api.agentbase.ai/v1'.
