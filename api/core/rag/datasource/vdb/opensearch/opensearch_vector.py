...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=agentbase_config.OPENSEARCH_HOST,
            port=agentbase_config.OPENSEARCH_PORT,
            user=agentbase_config.OPENSEARCH_USER,
            password=agentbase_config.OPENSEARCH_PASSWORD,
            secure=agentbase_config.OPENSEARCH_SECURE,
        )
