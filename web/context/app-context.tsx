...
import type { ICurrentWorkspace, Agent-BaseVersionResponse, UserProfileResponse } from '@/models/common'
...
export const AppContextProvider: FC<AppContextProviderProps> = ({ children }) => {
  ...
  const [langeniusVersionInfo, setLangeniusVersionInfo] = useState<Agent-BaseVersionResponse>(initialLangeniusVersionInfo)
