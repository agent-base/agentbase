const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AgentBase cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AgentBase.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AgentBase Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
