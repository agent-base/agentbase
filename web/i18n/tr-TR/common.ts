const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AgentBase hesabı',
    langGeniusAccountTip: 'AgentBase hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, AgentBase\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AgentBase tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, AgentBase\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} şimdi mevcut.',
    latestAvailable: 'AgentBase {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
