    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=agentbase_config.MYSCALE_HOST,
                port=agentbase_config.MYSCALE_PORT,
                user=agentbase_config.MYSCALE_USER,
                password=agentbase_config.MYSCALE_PASSWORD,
                database=agentbase_config.MYSCALE_DATABASE,
                fts_params=agentbase_config.MYSCALE_FTS_PARAMS,
            ),
        )
