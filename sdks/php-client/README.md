...
This is the PHP SDK for the AgentBase API, which allows you to easily integrate AgentBase into your PHP applications.
...
use YourVendorName\AgentBasePHP\AgentBaseClient;
use YourVendorName\AgentBasePHP\CompletionClient;
use YourVendorName\AgentBasePHP\ChatClient;

$apiKey = 'your-api-key-here';

$agentbaseClient = new AgentBaseClient($apiKey);
...
$response = $agentbaseClient->file_upload("user_id", $fileForUpload);
$result = json_decode($response->getBody(), true);
echo 'upload_file_id: ' . $result['id'];

// Fetch application parameters
$response = $agentbaseClient->get_application_parameters("user_id");

// Provide feedback for a message
$response = $agentbaseClient->message_feedback($message_id, $rating, "user_id");
