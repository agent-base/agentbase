const translation = {
  ...
  welcome: 'Witaj w AgentBase, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej AgentBase, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na AgentBase',
  invalid: 'Link wygasł',
  explore: 'Odkryj AgentBase',
