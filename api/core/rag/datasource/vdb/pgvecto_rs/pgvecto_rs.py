    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=agentbase_config.PGVECTO_RS_HOST,
                port=agentbase_config.PGVECTO_RS_PORT,
                user=agentbase_config.PGVECTO_RS_USER,
                password=agentbase_config.PGVECTO_RS_PASSWORD,
                database=agentbase_config.PGVECTO_RS_DATABASE,
            ),
            dim=dim,
        )
