          ...
          <a
            ...
            href={
              locale === LanguagesSupported[1]
                ? 'https://docs.agentbase.ai/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application'
                : 'https://docs.agentbase.ai/guides/knowledge-base/integrate-knowledge-within-application'
            }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - AgentBase`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.agentbase.ai/images/dataset-default-icon.png'}
