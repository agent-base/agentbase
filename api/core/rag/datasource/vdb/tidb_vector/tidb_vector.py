    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=agentbase_config.TIDB_VECTOR_HOST,
                port=agentbase_config.TIDB_VECTOR_PORT,
                user=agentbase_config.TIDB_VECTOR_USER,
                password=agentbase_config.TIDB_VECTOR_PASSWORD,
                database=agentbase_config.TIDB_VECTOR_DATABASE,
                program_name=agentbase_config.APPLICATION_NAME,
            ),
        )
