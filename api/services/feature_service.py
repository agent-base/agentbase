...
class FeatureService:
    ...
    def get_features(cls, tenant_id: str) -> FeatureModel:
        ...
        if agentbase_config.BILLING_ENABLED:
    ...
    def get_system_features(cls) -> SystemFeatureModel:
        ...
        if agentbase_config.ENTERPRISE_ENABLED:
    ...
    def _fulfill_params_from_env(cls, features: FeatureModel):
        features.can_replace_logo = agentbase_config.CAN_REPLACE_LOGO
        features.model_load_balancing_enabled = agentbase_config.MODEL_LB_ENABLED
        features.dataset_operator_enabled = agentbase_config.DATASET_OPERATOR_ENABLED
