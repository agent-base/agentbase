...
export declare class AgentBaseClient {
...
export declare class CompletionClient extends AgentBaseClient {
...
export declare class ChatClient extends AgentBaseClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends AgentBaseClient {
