const translation = {
  ...
  welcome: 'Bem-vindo ao AgentBase, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AgentBase, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AgentBase',
  invalid: 'O link expirou',
  explore: 'Explorar o AgentBase',
