...
from core.callback_handler.agent_tool_callback_handler import AgentBaseAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import AgentBaseWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: AgentBaseAgentCallbackHandler,
    ...
    def workflow_invoke(
        ...
        user_id: str,
        workflow_tool_callback: AgentBaseWorkflowCallbackHandler,
