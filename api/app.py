...
def create_flask_app_with_configs() -> Flask:
    ...
    """
    agentbase_app = AgentBaseApp(__name__)
    agentbase_app.config.from_mapping(agentbase_config.model_dump())

    # populate configs into system environment variables
    for key, value in agentbase_app.config.items():
