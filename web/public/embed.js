 ...
 * the agentbaseChatbotConfig should be defined in the html file before this script is included
 * the agentbaseChatbotConfig should contain the token of the chatbot
...
(function () {
  ...
  const configKey = "agentbaseChatbotConfig";
  const buttonId = "agentbase-chatbot-bubble-button";
  const iframeId = "agentbase-chatbot-bubble-window";
  ...
  async function embedChatbot() {
    ...
    const baseUrl =
      config.baseUrl || `https://${config.isDev ? "dev." : ""}uagentbase.app`;
    ...
    function createIframe() {
      ...
      iframe.title = "agentbase chatbot bubble window";
      iframe.id = iframeId;
