...
class FileService:
    ...
    def upload_file(file: FileStorage, user: Union[Account, EndUser], only_image: bool = False) -> UploadFile:
        ...
        if extension.lower() in IMAGE_EXTENSIONS:
            file_size_limit = agentbase_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024
        else:
            file_size_limit = agentbase_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024
        ...
        upload_file = UploadFile(
            ...
            storage_type=agentbase_config.STORAGE_TYPE,
            key=file_key,
            name=filename,
            size=file_size,
            extension=extension,
