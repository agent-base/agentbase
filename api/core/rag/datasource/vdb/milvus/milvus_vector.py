...
class MilvusVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            collection_name=collection_name,
            config=MilvusConfig(
                uri=agentbase_config.MILVUS_URI,
                token=agentbase_config.MILVUS_TOKEN,
                user=agentbase_config.MILVUS_USER,
                password=agentbase_config.MILVUS_PASSWORD,
                database=agentbase_config.MILVUS_DATABASE,
            ),
        )
