...
class AgentBaseClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? "https://api.agentbase.ai/v1/";
...
class CompletionClient extends AgentBaseClient {
...
class ChatClient extends AgentBaseClient {
...
class WorkflowClient extends AgentBaseClient{
