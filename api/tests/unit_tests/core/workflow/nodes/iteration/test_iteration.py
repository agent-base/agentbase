...
def test_run():
    ...
    pool = VariablePool(
        system_variables={
            SystemVariableKey.QUERY: "agentbase",
    ...
    pool.add(["pe", "list_output"], ["agentbase-1", "agentbase-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "agentbase"},
            outputs={"output": "agentbase 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["agentbase 123", "agentbase 123"]}
