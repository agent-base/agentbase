const translation = {
  ...
  welcome: 'Welcome to AgentBase, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AgentBase Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on AgentBase',
  invalid: 'The link has expired',
  explore: 'Explore AgentBase',
