const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: '<a href="https://docs.agentbase.ai/guides/knowledge-base/sync-from-website">https://docs.agentbase.ai/guides/knowledge-base/sync-from-website</a>',
      options: 'گزینهها',
