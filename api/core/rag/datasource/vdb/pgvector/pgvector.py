    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=agentbase_config.PGVECTOR_HOST,
                port=agentbase_config.PGVECTOR_PORT,
                user=agentbase_config.PGVECTOR_USER,
                password=agentbase_config.PGVECTOR_PASSWORD,
                database=agentbase_config.PGVECTOR_DATABASE,
            ),
        )
