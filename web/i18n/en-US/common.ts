const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AgentBase account',
    langGeniusAccountTip: 'Your AgentBase account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AgentBase to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AgentBase allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AgentBase\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} is now available.',
    latestAvailable: 'AgentBase {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
