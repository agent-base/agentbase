const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto AgentBase',
    langGeniusAccountTip: 'Twoje konto AgentBase i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do AgentBase, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez AgentBase pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach AgentBase.',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} jest teraz dostępny.',
    latestAvailable: 'AgentBase {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
