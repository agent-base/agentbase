...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = agentbase_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = agentbase_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = agentbase_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
