...
class APIBasedExtensionRequestor:
    ...
    def request(self, point: APIBasedExtensionPoint, params: dict) -> dict:
        ...
        try:
            ...
            proxies = None
            if agentbase_config.SSRF_PROXY_HTTP_URL and agentbase_config.SSRF_PROXY_HTTPS_URL:
                proxies = {
                    "http": agentbase_config.SSRF_PROXY_HTTP_URL,
                    "https": agentbase_config.SSRF_PROXY_HTTPS_URL,
                }
