# AgentBase Node.js SDK
This is the Node.js SDK for the AgentBase API, which allows you to easily integrate AgentBase into your Node.js applications.

## Install
```bash
npm install agentbase-client
```
...
```js
import { AgentBaseClient, ChatClient, CompletionClient } from 'agentbase-client'
...
const client = new AgentBaseClient(API_KEY)
...
Replace 'your-api-key-here' with your actual AgentBase API key.Replace 'your-app-id-here' with your actual AgentBase APP ID.
