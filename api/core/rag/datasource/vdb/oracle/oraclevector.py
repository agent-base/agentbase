    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                host=agentbase_config.ORACLE_HOST,
                port=agentbase_config.ORACLE_PORT,
                user=agentbase_config.ORACLE_USER,
                password=agentbase_config.ORACLE_PASSWORD,
                database=agentbase_config.ORACLE_DATABASE,
            ),
        )
