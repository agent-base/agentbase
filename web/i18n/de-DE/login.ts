const translation = {
  ...
  welcome: 'Willkommen bei AgentBase, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AgentBase Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AgentBase beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AgentBase erkunden',
