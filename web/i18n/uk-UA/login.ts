const translation = {
  ...
  welcome: 'Ласкаво просимо до AgentBase, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском AgentBase Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда AgentBase',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте AgentBase',
