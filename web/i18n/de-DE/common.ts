const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AgentBase-Konto',
    langGeniusAccountTip: 'Ihr AgentBase-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AgentBase anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AgentBase ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in AgentBases Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'AgentBase {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AgentBase {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
