const translation = {
  ...
  welcome: 'به AgentBase خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AgentBase Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AgentBase',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AgentBase',
